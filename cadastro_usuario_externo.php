				...
				<div class="card-header">
					<div class="row">
						...
						<div class="col-md-3" align="right">
							<a href="School.php" role="button" type="usbmit" class="btn btn-sm btn-primary">Voltar</a>
						</div>
					</div>
				</div>
			</div>
...
<div class="container" style="width: 400px; margin-top: 40px;">
  ...
  <a href="" role="button" type="usbmit" class="btn btn-sm btn-primary">Voltar</a></div>
	<h5></h5>-->
